...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',return_sequences=True, 
                                  implementation=2, name='bidir_rnn'), 
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # Add batch normalization for cnn
    bn_cnn = BatchNormalization(name='bn_conv_1d')(conv_1d)   
    ...
    for i in range(recur_layers):
        bidir_rnn = Bidirectional(GRU(units, activation='relu', 
                     return_sequences=True, implementation=2, dropout=0.2), 
                     name='bidir_rnn_{}'.format(i+1))(bn_bidir_rnn)
        bn_bidir_rnn = BatchNormalization(name='bn_bidir_rnn_{}'.format(i+1))(bidir_rnn)    
